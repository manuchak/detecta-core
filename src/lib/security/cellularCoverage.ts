...
export const CELLULAR_DEAD_ZONES: CellularDeadZone[] = [
  ...
  // SAN LUIS POTOSÍ - MATEHUALA (EXTENDIDO km 70-200)
  {
    id: 'deadzone-altiplano-slp',
    name: 'Altiplano Potosino (Charcas - Matehuala)',
    corridorId: 'slp-matehuala-saltillo',
    kmStart: 70,
    kmEnd: 200,
    center: [-100.7000, 23.0000],
    polygon: [
      [-100.9500, 22.6000],
      [-100.4500, 22.6000],
      [-100.4500, 23.5000],
    ...
    confidenceScore: 90,
    bestCarrier: 'Telcel',
    recommendation: 'Telcel débil e intermitente. ATT/Movistar sin señal. Comunicación satelital OBLIGATORIA. Check-in km 70 y km 200.',
  ...
  // ============================================================
  // NORPONIENTE - Zonas muertas nuevas
  // ============================================================
  {
    id: 'deadzone-espinazo-diablo-ext',
    name: 'Espinazo del Diablo (Extendido)',
    corridorId: 'mazatlan-durango-torreon',
    kmStart: 50,
    kmEnd: 120,
    center: [-105.9000, 23.5500],
    polygon: [
      [-106.2000, 23.3000],
      [-105.6000, 23.3000],
      [-105.6000, 23.8000],
    ...
    confidenceScore: 96,
    bestCarrier: null,
    recommendation: 'ZONA CRÍTICA. Sin cobertura total ~70km. Comunicación satelital OBLIGATORIA. Reportar km 50 y km 120.',
    altitudeRange: '2,000 - 2,800 msnm',
    iftGuaranteed: false,
  },
  {
    id: 'deadzone-desierto-sonora',
    name: 'Desierto de Sonora (Hermosillo-Magdalena)',
    corridorId: 'hermosillo-nogales',
    kmStart: 50,
    kmEnd: 90,
    center: [-110.9500, 29.5000],
    polygon: [
      [-111.2000, 29.2000],
      [-110.7000, 29.2000],
      [-110.7000, 29.8000],
    ...
    confidenceScore: 82,
    bestCarrier: 'Telcel',
    recommendation: 'Telcel débil e intermitente. ATT/Movistar sin señal. Verificar combustible.',
    iftGuaranteed: false,
  },
  {
    id: 'deadzone-sierra-nayarit',
    name: 'Sierra de Nayarit (Barrancas GDL-Tepic)',
    corridorId: 'guadalajara-tepic',
    kmStart: 80,
    kmEnd: 150,
    center: [-104.3000, 21.1000],
    polygon: [
      [-104.6000, 20.9000],
      [-104.0000, 20.9000],
      [-104.0000, 21.3000],
    ...
    confidenceScore: 80,
    bestCarrier: 'Telcel',
    recommendation: 'Telcel débil en sierra. ATT/Movistar sin señal. Cobertura limitada ~30km.',
    altitudeRange: '1,200 - 2,000 msnm',
    iftGuaranteed: false,
  },
];
