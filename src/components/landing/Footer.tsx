      ...
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="font-bold text-lg">Lead Flow Navigator</h3>
            <p className="text-muted-foreground">
              Transformando la gestión de leads y servicios para empresas modernas.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="#features" className="text-muted-foreground hover:text-foreground transition-colors">Características</Link></li>
              <li><Link to="#pricing" className="text-muted-foreground hover:text-foreground transition-colors">Precios</Link></li>
              <li><Link to="#testimonials" className="text-muted-foreground hover:text-foreground transition-colors">Testimonios</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-border/60 text-center text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} Lead Flow Navigator. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
