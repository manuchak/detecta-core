...
export const ServiceStatusChart = ({ data, metrics }: ServiceStatusChartProps) => {
  ...
  return (
    <Card className="lg:col-span-1 card-apple h-[500px]">
      <CardHeader className="pb-2">
        <CardTitle className="text-base font-semibold">Estado de Servicios</CardTitle>
      </CardHeader>
      <CardContent className="h-[440px] p-4">
        <Tabs defaultValue="chart" className="h-full">
          <TabsList className="mb-3 h-9">
            <TabsTrigger value="chart" className="text-sm px-3">Gráfico</TabsTrigger>
            <TabsTrigger value="numbers" className="text-sm px-3">Números</TabsTrigger>
          </TabsList>
          
          <TabsContent value="chart" className="h-[380px]">
          ...
          <TabsContent value="numbers" className="h-[380px] overflow-y-auto">
