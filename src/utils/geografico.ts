...
export const CIUDADES_PRINCIPALES = {
  ...
  'nogales': { lat: 31.3100, lng: -110.9400, estado: 'Sonora', aliases: ['nogales sonora'] },
  'mexicali': { lat: 32.6300, lng: -115.4700, estado: 'Baja California', aliases: [] },
  'caborca': { lat: 30.7167, lng: -112.1597, estado: 'Sonora', aliases: [] },
  'san_luis_rio_colorado': { lat: 32.4500, lng: -114.7700, estado: 'Sonora', aliases: ['san luis rc', 'san luis rio colorado'] },
  'tecate': { lat: 32.5700, lng: -116.6300, estado: 'Baja California', aliases: [] },
