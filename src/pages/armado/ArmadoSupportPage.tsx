...
const ArmadoSupportPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <ArmadoBottomNav activeItem="support" onNavigate={(item) => {
        if (item === 'home') navigate('/armado');
        else if (item === 'services') navigate('/armado/services');
      }} />
    </div>
  );
};

export default ArmadoSupportPage;
