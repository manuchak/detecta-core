...
export function CSLoyaltyFunnel({ onStageClick, selectedStage }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* En Riesgo - independent alert outside funnel card */}
      {riesgoItem && riesgoItem.count > 0 && (
        <button
          onClick={() => onStageClick?.('en_riesgo')}
          className={`w-full flex items-center gap-3 p-3 rounded-lg bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 transition-all hover:shadow-md cursor-pointer ${
