-- Critical Security Fix: Add Row Level Security policies for exposed sensitive tables
...
-- 7. Secure rewards table (currently accessible to all authenticated users)
