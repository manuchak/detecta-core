-- Insertar datos de ejemplo con valores correctos para todas las restricciones
...
-- 3. Insertar candidatos custodios (calificacion_inicial: 1-10, estado_proceso válidos)
