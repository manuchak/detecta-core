...
-- Drop and recreate functions with proper security configuration

DROP FUNCTION IF EXISTS public.update_forecast_config_updated_at();
...
DROP FUNCTION IF EXISTS public.update_custodios_rotacion_timestamp();
