...
-- Drop the existing view (not materialized view)
DROP VIEW IF EXISTS public.custodios_operativos_disponibles;

-- Create materialized view with real activity filter
