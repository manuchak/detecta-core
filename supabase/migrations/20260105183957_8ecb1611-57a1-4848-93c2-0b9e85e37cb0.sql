-- Fix timezone bug: Convert to CDMX timezone before extracting date for filtering
-- This ensures services scheduled for late evening CDMX don't appear on the wrong day
...
BEGIN
  ...
  WITH service_stats AS (
    ...
    -- FIX: Convert to CDMX timezone before extracting date
