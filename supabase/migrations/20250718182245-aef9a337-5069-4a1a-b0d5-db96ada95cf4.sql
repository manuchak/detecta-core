-- Insertar datos de ejemplo usando los IDs reales de las zonas existentes
...
-- 2. Insertar alertas del sistema nacional (usando zona_id reales)
INSERT INTO public.alertas_sistema_nacional (
  ...
  ('Déficit Crítico - Centro de México', 'Se requieren 15 custodios adicionales en la zona centro para cubrir la demanda', 'deficit_critico', 'operacional', 1, '44dafbdf-de68-41d0-837f-b4c0172980fc', 'activa', '{"deficit": 15, "demanda": 45}', ARRAY['Activar campaña intensiva', 'Considerar bonos de referido'], now(), now()),
  ('Oportunidad de Expansión - Bajío', 'Zona con potencial de crecimiento identificado', 'oportunidad', 'estrategica', 3, 'ea9f8e34-9a40-49ef-af3b-521a6d964cbe', 'activa', '{"potencial": "alto", "competencia": "baja"}', ARRAY['Evaluar mercado local', 'Preparar estrategia de entrada'], now(), now()),
  ('Meta Alcanzada - Occidente', 'Zona occidente ha superado las expectativas del mes', 'meta_alcanzada', 'positiva', 5, '562be149-7d10-4dbe-bf21-c3c22dec9440', 'activa', '{"superacion": "20%", "eficiencia": "alta"}', ARRAY['Reconocer equipo', 'Compartir mejores prácticas'], now(), now()),
