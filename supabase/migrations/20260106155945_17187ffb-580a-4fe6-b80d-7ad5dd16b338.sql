-- Corregir función RPC para usar timezone CDMX en comparaciones de fecha
-- Problema: DATE(fecha_hora_cita) sin timezone causa desfase de 6 horas
...
BEGIN
  ...
  -- Contar servicios asignados hoy en servicios_custodia (CORREGIDO: usar timezone CDMX)
  ...
  -- Sumar servicios planificados (CORREGIDO: usar timezone CDMX)
  ...
  -- Verificar conflictos horarios en servicios_custodia (CORREGIDO: usar timezone CDMX)
  ...
  -- Calcular horas trabajadas aproximadas hoy (CORREGIDO: usar timezone CDMX)
  ...
  -- Calcular días sin asignar servicio (CORREGIDO: usar timezone CDMX)
