-- CREAR DATOS DE PRUEBA CORREGIDOS

-- Insertar métricas de demanda de ejemplo (sin deficit_custodios que es generado)
...
SELECT 
  ...
  'La zona Centro de México presenta un déficit crítico, afectando la capacidad de atención.',
  '{"custodios_activos": 8, "requeridos": 20}'::jsonb,
  9,
  'activa',
