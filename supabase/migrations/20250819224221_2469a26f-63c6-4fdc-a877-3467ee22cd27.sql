-- Corregir el tipo de dato en la función para que coincida con la tabla
...
RETURNS TABLE(
    ...
    zona_nombre VARCHAR(100), -- Cambiado de TEXT a VARCHAR(100) para coincidir con la tabla
    asignado_a UUID,
