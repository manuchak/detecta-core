-- Corregir la función usando las columnas correctas
...
BEGIN
    ...
    SELECT 
        ...
        CASE 
            WHEN l.interruption_reason IS NOT NULL THEN true 
            ELSE false 
        END as interview_interrupted,
    ...
    WHERE (
        -- Si es admin, ver todos los leads asignados o en pool
