-- Corregir función liberar_custodio_a_planeacion - Usar columnas correctas
-- Problema: custodio_operativo_id y aprobado_por NO existen en la tabla
-- Corrección: Eliminar custodio_operativo_id del UPDATE, usar liberado_por
...
BEGIN
  ...
  -- 5. Actualizar custodio_liberacion con columnas que SÍ existen
