-- PHASE 3 RETRY: Replace functions without dropping dependencies

-- Ensure user_has_role_direct has correct body (keep existing parameter name)
...
-- Remove email bypass from is_admin_bypass_rls
...
-- Update reward bypass functions to rely on roles only
