-- Insertar datos de ejemplo excluyendo todas las columnas generadas
...
-- 2. Insertar alertas del sistema nacional (usando valores válidos)
...
-- 3. Insertar candidatos custodios (con valores correctos)
INSERT INTO public.candidatos_custodios (
  ...
  ('Juan Pérez García', 'juan.perez@email.com', '+52-555-0101', '44dafbdf-de68-41d0-837f-b4c0172980fc', 'entrevista', true, true, 35000, 'referido', 9, now(), now()),
  ('María González López', 'maria.gonzalez@email.com', '+52-555-0102', 'ea9f8e34-9a40-49ef-af3b-521a6d964cbe', 'entrevista', false, true, 30000, 'online', 8, now(), now()),
  ('Carlos Ruiz Mendoza', 'carlos.ruiz@email.com', '+52-555-0103', '562be149-7d10-4dbe-bf21-c3c22dec9440', 'activo', true, false, 32000, 'evento', 10, now(), now()),
  ('Ana Martínez Silva', 'ana.martinez@email.com', '+52-555-0104', '44dafbdf-de68-41d0-837f-b4c0172980fc', 'lead', false, false, 28000, 'social_media', 7, now(), now()),
  ('Roberto Hernández Cruz', 'roberto.hernandez@email.com', '+52-555-0105', 'ea9f8e34-9a40-49ef-af3b-521a6d964cbe', 'documentacion', true, true, 33000, 'referido', 9, now(), now()),
  ('Elena Vargas Morales', 'elena.vargas@email.com', '+52-555-0106', '38885a88-c10c-4e18-9a7b-4a75469c4064', 'entrevista', false, true, 31000, 'online', 8, now(), now())
ON CONFLICT DO NOTHING;

-- 4. Insertar métricas de reclutamiento (excluyendo columnas generadas)
INSERT INTO public.metricas_reclutamiento (
  zona_id, canal, periodo_inicio, periodo_fin, inversion_marketing, 
  leads_generados, candidatos_calificados, custodios_contratados, created_at
) VALUES 
  ('44dafbdf-de68-41d0-837f-b4c0172980fc', 'referido', '2024-12-01', '2024-12-31', 15000, 25, 12, 8, now()),
  ('ea9f8e34-9a40-49ef-af3b-521a6d964cbe', 'online', '2024-12-01', '2024-12-31', 9000, 18, 10, 5, now()),
  ('562be149-7d10-4dbe-bf21-c3c22dec9440', 'evento', '2024-12-01', '2024-12-31', 26400, 40, 22, 12, now()),
  ('38885a88-c10c-4e18-9a7b-4a75469c4064', 'social_media', '2024-12-01', '2024-12-31', 9600, 15, 8, 3, now())
ON CONFLICT DO NOTHING;
