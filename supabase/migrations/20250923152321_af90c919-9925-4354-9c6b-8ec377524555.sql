-- Función para migrar datos de vehículos desde servicios_custodia a custodios_vehiculos
  ...
  LOOP
    ...
    IF NOT EXISTS (
      ...
      BEGIN
        ...
        -- Buscar o crear custodio en custodios_operativos
        DECLARE
...
-- Función RPC para obtener datos de vehículo con fallback
...
AS $$
BEGIN
  -- Primero buscar en custodios_vehiculos
  RETURN QUERY
  SELECT 
    cv.marca,
    cv.modelo,
