-- Fix RPC functions: First DROP then recreate with correct table (leads)
...
-- Recreate get_analyst_assigned_leads using leads table
...
-- Recreate get_analyst_assigned_leads_v2 using leads table
...
-- Recreate count_analyst_assigned_leads using leads table
CREATE FUNCTION public.count_analyst_assigned_leads(
  p_date_from TIMESTAMPTZ DEFAULT NULL,
  p_date_to TIMESTAMPTZ DEFAULT NULL
)
RETURNS INTEGER
...
-- Recreate count_analyst_assigned_leads_v2 using leads table
