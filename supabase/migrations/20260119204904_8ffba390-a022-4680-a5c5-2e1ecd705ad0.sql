-- ============================================================
-- FIX: Corregir valores de tipo_alerta y estado que violan CHECK constraints
-- tipo_alerta: 'info' -> 'preventiva' (válidos: critica, preventiva, estrategica)
-- estado: 'activo' -> 'activa' (válidos: activa, en_proceso, resuelta, descartada)
-- ============================================================
...
BEGIN
  ...
  -- 6. Insertar notificación para Planeación (CORREGIDO: valores válidos según CHECK constraints)
  INSERT INTO alertas_sistema_nacional (
    ...
    'preventiva',  -- FIX: era 'info', valores válidos: critica, preventiva, estrategica
    'liberacion',
    ...
    'activa',      -- FIX: era 'activo', valores válidos: activa, en_proceso, resuelta, descartada
    2,
    jsonb_build_object(
