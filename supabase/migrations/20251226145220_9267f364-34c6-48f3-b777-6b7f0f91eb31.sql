...
-- Recrear get_analyst_assigned_leads_v2 con candidato_custodio_id
...
BEGIN
  ...
  WHERE (
    ...
    AND (p_is_test IS NULL OR COALESCE(l.is_test, false) = p_is_test)
...
-- Recrear get_analyst_assigned_leads con candidato_custodio_id
