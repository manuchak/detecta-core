...
-- 1. Insertar métricas de demanda de zona (datos ejemplo)
INSERT INTO public.metricas_demanda_zona (
  zona_id, deficit_custodios, demanda_mensual, custodios_activos, 
  score_urgencia, tendencia_demanda, created_at, updated_at
) VALUES 
  ('11111111-1111-1111-1111-111111111111', 15, 45, 30, 85, 'creciente', now(), now()),
  ('22222222-2222-2222-2222-222222222222', 8, 25, 17, 65, 'estable', now(), now()),
  ('33333333-3333-3333-3333-333333333333', 22, 60, 38, 95, 'creciente', now(), now()),
  ('44444444-4444-4444-4444-444444444444', 5, 20, 15, 45, 'decreciente', now(), now())
