-- Corregir función liberar_custodio_a_planeacion - Obtener vehículo de custodio_liberacion
-- Problema: vehiculos_candidatos NO existe, los datos están en custodio_liberacion
...
DECLARE
  ...
  v_vehiculo_marca text;
  v_vehiculo_modelo text;
  v_vehiculo_placa text;
  v_vehiculo_color text;
  v_result jsonb;
BEGIN
  -- 1. Obtener información del candidato y vehículo desde custodio_liberacion
  SELECT 
    cl.candidato_id,
  ...
  -- 3. Buscar o crear registro en pc_custodios PRIMERO
  ...
  IF v_pc_custodio_id IS NULL THEN
    -- Crear nuevo registro en pc_custodios con datos del vehículo
