...
-- Insertar datos de marcas (si no existen)
INSERT INTO marcas_gps (id, nombre, pais_origen, sitio_web, soporte_wialon, activo) VALUES 
(gen_random_uuid(), 'Queclink', 'China', 'https://www.queclink.com', true, true),
(gen_random_uuid(), 'Suntech', 'Korea', 'https://suntechint.com', true, true)
