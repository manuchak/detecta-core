-- Recrear vista vw_servicios_facturacion corrigiendo la lógica de proveedor
-- Eliminar el fallback a sc.proveedor que trae datos incorrectos (EX-MILITAR, Seter, etc.)
...
SELECT 
    ...
    -- CORREGIDO: Solo mostrar proveedor cuando hay asignación formal a proveedor externo
    -- Se elimina el fallback "sc.proveedor" que traía datos incorrectos (EX-MILITAR, Seter, etc.)
    CASE 
