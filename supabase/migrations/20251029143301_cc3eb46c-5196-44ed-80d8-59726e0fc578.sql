-- ============================================
-- FASE 4B (CORREGIDA): Función RPC Segura para Conversión de Leads
-- ============================================

DROP FUNCTION IF EXISTS convertir_lead_a_armado_operativo(text);
...
Solo accesible por planificadores/admin con validación de permisos.';